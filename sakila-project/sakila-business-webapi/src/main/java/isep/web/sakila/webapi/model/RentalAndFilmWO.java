...
public class RentalAndFilmWO extends WebObject {
	...
	public RentalAndFilmWO(int rentalId, String rentalDate, int inventoryId, int customerId, String returnDate,
			byte staffId) {
		super();
	...
	public RentalAndFilmWO(final Rental rental) {
		super();
